<template>
  <div class="FormSign">
    <img class="wave" src="../assets/images/formlogin/wave.png" />
    <div class="container">
      <div class="img">
        <img src="../assets/images/formlogin/bg.svg" />
      </div>
...
.btn {
  ...
  outline: none;
  border: none;
  background-image: linear-gradient(to right, #32be8f, #12cad6, #32be8f);
  background-size: 200%;
  font-size: 1.2rem;
  color: #fff;
  font-family: "Poppins", sans-serif;
